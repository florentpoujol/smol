...
trait DateTimeMutatorsTrait
{
    ...
    {
        $dt = new $this->fqcn('2022-02-27 12:25:01.123456');
        ...
        if ($dt instanceof DateTimeImmutable) {
            self::assertSame('2022-02-27 12:25:01.123456', $dt->format('Y-m-d H:i:s.u'));
        } else {
    ...
    {
        // month
        $actual = (new $this->fqcn('2022-01-31 12:25:01.123456'))->addMonthsWithoutOverflow(1)->toDateTimeString();
        self::assertSame('2022-02-28 12:25:01', $actual);

        $actual = (new $this->fqcn('2020-02-29 12:25:01.123456'))->addMonthsWithoutOverflow(13)->toDateTimeString();
        self::assertSame('2021-03-29 12:25:01', $actual);

        $actual = (new $this->fqcn('2020-11-29 12:25:01.123456'))->addMonthsWithoutOverflow(27)->toDateTimeString();
        self::assertSame('2023-02-28 12:25:01', $actual);

        // year
        $actual = (new $this->fqcn('2022-01-31 12:25:01.123456'))->addYearsWithoutOverflow(1)->toDateTimeString();
        self::assertSame('2023-01-31 12:25:01', $actual);

        $actual = (new $this->fqcn('2020-02-29 12:25:01.123456'))->addYearsWithoutOverflow(2)->toDateTimeString();
        self::assertSame('2022-02-28 12:25:01', $actual);

        $actual = (new $this->fqcn('2020-11-29 12:25:01.123456'))->addYearsWithoutOverflow(3)->toDateTimeString();
    ...
    public function test_sub(): void
    {
        ...
        $isImmutable = $dt instanceof DateTimeImmutable;
        ...
        if ($isImmutable) {
            self::assertSame(25, $dt->getMinute());
            self::assertSame(2, $dt->subMinutes(23)->getMinute());
        } else {
        ...
        if ($isImmutable) {
            self::assertSame(2022, $dt->getYear());
            self::assertSame(2020, $dt->subYears(2)->getYear());
        } else {
    ...
    {
        // month
        $actual = (new $this->fqcn('2022-03-31 12:25:01.123456'))->subMonthsWithoutOverflow(1)->toDateTimeString();
        self::assertSame('2022-02-28 12:25:01', $actual);

        $actual = (new $this->fqcn('2020-02-29 12:25:01.123456'))->subMonthsWithoutOverflow(13)->toDateTimeString();
        self::assertSame('2019-01-29 12:25:01', $actual);

        $actual = (new $this->fqcn('2020-02-29 12:25:01.123456'))->subMonthsWithoutOverflow(27)->toDateTimeString();
        self::assertSame('2017-11-29 12:25:01', $actual);

        // year
        $actual = (new $this->fqcn('2022-03-31 12:25:01.123456'))->subYearsWithoutOverflow(1)->toDateTimeString();
        self::assertSame('2021-03-31 12:25:01', $actual);

        $actual = (new $this->fqcn('2020-02-29 12:25:01.123456'))->subYearsWithoutOverflow(3)->toDateTimeString();
        self::assertSame('2017-02-28 12:25:01', $actual);

        $actual = (new $this->fqcn('2020-02-29 12:25:01.123456'))->subYearsWithoutOverflow(4)->toDateTimeString();
